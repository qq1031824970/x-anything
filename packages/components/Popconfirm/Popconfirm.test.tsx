...
//     expect(XPopconfirm.install).toBeDefined()
//   })

//   // 测试 Popconfirm 组件是否被正确导出
//   it('should be exported Popconfirm component', () => {
//     expect(XPopconfirm).toBe(PopConfirm)
//   })
...
//     expect(enhancedPopconfirm).toBe(XPopconfirm)
...
describe('Popconfirm.vue', () => {
  ...
  //   expect(wrapper.find('.x-popconfirm').exists()).toBeTruthy()
  //   const confirmBtn = wrapper.find('.x-popconfirm__confirm')
  //   expect(confirmBtn.exists()).toBeTruthy()

  //   confirmBtn.trigger('click')
  //   await vi.runAllTimers()
  //   expect(wrapper.find('.x-popconfirm').exists()).toBeFalsy()
  ...
  //   const cancelBtn = wrapper.find('.x-popconfirm__cancel')
