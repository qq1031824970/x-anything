...
import { useZIndex } from "@x-anything/hooks";
import LoadingComp from "./Loading.vue";
import { defer, delay, isNil, isString } from "lodash-es";

const RELATIVE_CLASS = "x-loading-parent--relative" as const;
const HIDDEN_CLASS = "x-loading-parent--hiden" as const;
const LOADING_NUMB_KEY = "x-loading-numb" as const;
